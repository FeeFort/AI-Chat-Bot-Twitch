...
BANNED_VISUAL_FORMS = [
    # пидор, пидорас, педик, петух, гомик
    "пид0р", "пuдop", "пuд0р", "пuд0p", "пuдop", "пидop", "пuдор", "пuд0р",
    "пидорас", "пuдорас", "пuд0рас", "пид0рас", "пидоpас", "пид0pас", "пuд0pас",
    "педuк", "педuк", "пeдик", "пeдuк", "пeд0к", "пед0к", "пeдuк",
    "петух", "пeтух", "пeт0х", "пет0х", "пeт0x", "петуx", "пeтуx",
    "г0мик", "гoмик", "гoмuк", "г0мuк", "гoмuк",

    # ниггер, нига, нигга
    "нuггер", "нuггep", "нuггeр", "нuгг0р", "ниггep", "нигг0р", "нuгг0p", "nиггер", "nиггep", "nиггeр",
    "нuга", "нuгa", "нuг0", "нига", "нигa", "ниг0", "nига", "nигa", "nиг0",
    "нuгга", "нuггa", "нuгг0", "нигга", "ниггa", "нигг0", "nигга", "nиггa", "nигг0",

    # хохол, хач, жид
    "х0хол", "xoхол", "хoхол", "х0х0л", "xoхoл", "хoxол", "xoxол", "x0xол", "x0x0л",
    "хач", "xaч", "хaч", "xач", "xа4", "хa4", "xa4", "х4ч", "x4ч",
    "жuд", "жuд", "ж0д", "жид", "жuд", "жu0", "ж0д",

    # даун, аутист
    "даун", "дaун", "дayн", "дaун", "дaуn", "дayн", "дaуn", "д0ун", "д0уn", "дa0н",
    "аутuст", "аутuст", "аyтист", "аyтuст", "аутucт", "аyтucт", "а0тист", "aутист", "aутuст", "аyтuст",

    # хуесос, уебище
    "хуecoc", "xyecoc", "xуecoc", "хуeсoc", "xyесoc", "xyеcoс", "хуeс0с", "xyеcoс", "xуeс0c",
    "yeбище", "yебuще", "yeбuщe", "yебuщe", "уeбище", "yeбuще", "y0бище", "yeб0ще", "y0бuщe",

    # faggot, nigger, nigga, retard, cunt (латиница с подменой)
    "faggot", "fagg0t", "faggoт", "fаggot", "fаgg0т", "f4ggot", "f4gg0т",
    "nigger", "niggеr", "nigg3r", "n1gger", "n1gg3r", "niggеr", "n1ggеr",
    "nigga", "niggа", "n1gga", "n1ggа", "nigg4", "n1gg4",
    "retard", "retаrd", "ret4rd", "rеtard", "rеtаrd", "r3tard", "r3t4rd",
    "cunt", "cunt", "cunт", "cun7", "cunт", "cun7", "cun7",

    # дополнительные смешанные формы (русские буквы в английских словах)
    "faggот", "niggер", "niggа", "retарd", "cunт", "f4ggот", "n1ggер", "r3tарd",

    # полная цифровая подмена гласных и похожих букв
    "пuд0p", "пuд0p", "пuд0pас", "пeд0к", "пeт0х", "г0мuк", "нuгг0р", "нuг0",
    "x0x0л", "x4ч", "ж0д", "д0ун", "а0тuст", "xуeс0с", "y0бuщe",

    # комбинации с английскими o/a/e вместо русских
    "пidoр", "пidop", "пиdор", "пidoрас", "пetух", "гomик", "ниggер", "ниgga",
    "xoхол", "xaч", "жиd", "дayн", "ayтист", "xyecoс", "yeбище",
]
